...
const float FOAM_FALLOFF_BIAS = 2.0;     // Controls foam gradient (1.0 = hard edge)
const float FOAM_LEADING_EDGE = 1.0;     // Softens edge where foam meets object
const float FOAM_SCROLL_SPEED = 0.15;     // Speed of foam texture scrolling
const float FOAM_TILING = 2.0;           // How much to tile the foam texture
